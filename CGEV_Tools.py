...
nuke.pluginAddPath(path + './Gizmos/CGEV');
nuke.pluginAddPath(path + './Gizmos/CGEV/icons');

##########################################################################################################################################

tools = nuke.toolbar("Nodes")
C_menu = tools.addMenu("CGEV",  icon="CGEV.png")
...
nuke.toolbar("Nodes").addMenu("CGEV/Color").addSeparator()
...
nuke.toolbar("Nodes").addMenu("CGEV/Filter/Edge").addSeparator()
...
nuke.toolbar("Nodes").addMenu("CGEV/Transform").addSeparator()
...
nuke.toolbar("Nodes").addMenu("CGEV/3D/Position").addSeparator()
...
nuke.toolbar("Nodes").addMenu("CGEV/3D/Deep").addSeparator()
