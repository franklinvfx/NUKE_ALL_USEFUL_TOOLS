...
if existingNode is None:
    existingNode = nuke.nodePaste(pipe_path + '/Gizmos/C/ScanlineRender_Controller.gizmo')
    knob = nuke.Boolean_Knob('cgevscanline', 'cgevscanline', True)
    knob.setVisible(False)

    existingNode.addKnob(knob)

existingNode.setXYpos(existingBackdrop.xpos()+310, existingBackdrop.ypos()+85)
